...
def display_plot(mean_series, std_dev_series, labels, colors):
...
display_plot(mean_series=mean_series, std_dev_series=std_dev_series, colors=colors, labels=labels)
